...
class RSpider(scrapy.Spider):
    ...
    #     except:
    #         each_id = 'unknown'
    #     Character = create_character_model(each_id)
    #     Character.__table__.create(self.database().bind, checkfirst=True)
    #     insertion_query = Character(
    #         each_id=each_id,
    #         firstname=self.firstname.replace('_', ' '),
    #         surname=self.surname.replace('_', ' '),
    #         club=self.club.replace('_', ' '),
    #         event='Sample Event',
    #         time='00:30:00',
    #         race='Race 1',
    #         SSS='3.5',
